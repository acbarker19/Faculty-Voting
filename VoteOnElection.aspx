...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VoteOnElection.aspx.cs" Inherits="VoteOnElection" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:DropDownList ID="ddlPickElection" runat="server" DataSourceID="sdsElectionFaculty" DataTextField="ElectionID" DataValueField="ElectionID"></asp:DropDownList>
        <br />
        <br />
        ...
        <asp:SqlDataSource ID="sdsElectionFaculty" runat="server" ConnectionString="<%$ ConnectionStrings:FacultyVotingConnectionString %>" SelectCommand="SELECT [Username], [ElectionID], [CommitteeID] FROM [FacultyRunning] ORDER BY [ElectionID] DESC, [Username] DESC"></asp:SqlDataSource>
        <br />
