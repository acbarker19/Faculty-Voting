...
<body>
    <form id="form1" runat="server">
            ...
            <table>
                ...
                <tr>
                    <td colspan="2"><asp:Button ID="btnAddUser" runat="server" Text="Add User" BackColor="#990099" Font-Bold="True" ForeColor="White" BorderStyle="Solid" OnClick="btnEditUser"/></td>
                </tr>
                <tr>
